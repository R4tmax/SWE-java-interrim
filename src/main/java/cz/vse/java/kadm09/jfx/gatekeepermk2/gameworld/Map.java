...
public class Map {
    ...
    public static void fillMap () {
        ...
        Map.gameArea[0][0] = new Room("Northwestern rocky hills", """
        ...
        Map.gameArea[0][1] = new Room("Foot of the mountain", """
        ...
        Map.gameArea[0][2] = new Room("MONSTER NEST", "END OF THE LINE"/*, true , null, new TheMatriarch("Matriarch",1500, 13), RoomType.HOSTILE*/);
        Map.gameArea[0][3] = new Room("Chasm", """
        ...
        Map.gameArea[0][4] = new Room("Northeastern rocky hills", """
                You arrive at the small hill overseeing the forest underneath, due south.
        ...
        //Second row
        Map.gameArea[1][0] = new Room("Edge of the forest", """
                ...
                """/*, false , new Consumable("Blue Herb",25,ConsumableType.MANA_FILL), null, RoomType.RECON*/);
        Map.gameArea[1][1] = new Room("Deep forest", """
        ...
        Map.gameArea[1][2] = new Room("Deep forest", """
                As you make your way through the forrest, you feel cold and isolated.
                Even in the middle of the noon, the sun doesn't reach you here.
                You are not quite sure where exactly your are.
                """/*, false , null, null, RoomType.RECON*/);
        Map.gameArea[1][3] = new Room("Deep forest", """
        ...
        Map.gameArea[1][4] = new Room("Boggy forrest", """
        ...
        //third row
        Map.gameArea[2][0] = new Room("THE STRANGE CLEARING", """
        ...
        Map.gameArea[2][1] = new Room("Bush-filled plain", """
        ...
        Map.gameArea[2][2] = new Room("Edge of the forrest", """
        ...
        Map.gameArea[2][3] = new Room("Edge of the marsh", """
                ...
                """/*, false , null, null, RoomType.RECON*/);
        Map.gameArea[2][4] = new Room("THE DEEP SWAMP", """
        ...
        //fourth row
        Map.gameArea[3][0] = new Room("Dirt road", """
                ...
                """/*, false , null, null, RoomType.RECON*/);
        Map.gameArea[3][1] = new Room("Wheat field", """
        ...
        Map.gameArea[3][2] = new Room("Meadow", """
        ...
        Map.gameArea[3][3] = new Room("Lowland", """
                ...
                """/*, false , null, null, RoomType.RECON*/);
        Map.gameArea[3][4] = new Room("River meander", """
        ...
        //fifth row
        Map.gameArea[4][0] = new Room("The Kings Road", """
        ...
        Map.gameArea[4][1] = new Room("The Tavern", """
        ...
        Map.gameArea[4][2] = new Room("Village courtyard", """
        ...
        Map.gameArea[4][3] = new Room("The Market", """
        ...
        Map.gameArea[4][4] = new Room("River bank", """
